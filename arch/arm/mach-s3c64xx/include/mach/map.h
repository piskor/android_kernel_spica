...
//
// This file defines physical addresses of all used peripheral blocks
// and static IO mapping for some of them, which must not overlap with
// mappings defined in plat/map-base.h
//
...
#define S3C64XX_VA_MODEM	S3C_ADDR(0x00700000)

/* USB HS OTG */
#define S3C64XX_PA_USB_HSOTG	(0x7C000000)
#define S3C64XX_VA_USB_HSOTG	S3C_ADDR(0x00800000)
#define S3C64XX_SZ_USB_HSOTG	SZ_1M

/* High Speed USB */
#define S3C64XX_PA_USB_HSPHY	(0x7C100000)
#define S3C64XX_VA_USB_HSPHY	S3C_ADDR(0x00900000)
#define S3C64XX_SZ_USB_HSPHY	SZ_1M

/*
 * Peripherals which can be mapped optionally by machine specific code
 */

/* Display controller */
#define S3C64XX_PA_FB		(0x77100000)
#define S3C64XX_VA_FB	   	S3C_ADDR(0x00600000)
#define S3C64XX_SZ_FB		SZ_1M
...
#define S3C64XX_VA_SROM		S3C_ADDR(0x01100000)
#define S3C64XX_SZ_SROM		SZ_1M

/* HS OTG PHY */


/* OneNAND */
#define S3C64XX_VA_ONENAND0	S3C_ADDR(0x01800000)
#define S3C64XX_SZ_ONENAND0	SZ_1M
